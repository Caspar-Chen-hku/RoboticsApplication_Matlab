function PlotTwoSegments(theta1,theta2, op1, op2, Lsegment)
    ...
    Tb2 = [cos(2*theta(1)), sin(2*theta(1)),k(1)*sin(theta(1));...
    ...
    for ii = 1:size(ang2,2)
        ...
        curv2_u(:,ii) = Tb2*[curv2_2(:,ii);1];
        m = 1+1;
    end

    %
    figure(1),
    plot(curv1_u(1,:),curv1_u(2,:),curv2_u(1,:),curv2_u(2,:),...
